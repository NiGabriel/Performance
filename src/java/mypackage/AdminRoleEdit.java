...
public class AdminRoleEdit extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter();) {
            ...
            if (u == null) {
                ...
                out.println("<title>Admin - Edit Role</title>");
                out.println("</head>");
                out.println("<body>");

                String id = request.getParameter("sidrole");
                int myId = Integer.parseInt(id);

                user e = UserDatabase.getRoleById(myId);

                out.println("<div class=\"card\">");

                out.println("<div class=\"card-header\">\n"
                        + "			    <h2> Appraisal performance system - Modify role's data</h2>\n"
                        + "			</div>");
                ...
                out.print("<form action='RoleEditServlet' method='post'>");
                out.println("<div class=\"mb-3\">");
                out.print("<input type ='hidden' name ='rolid' value ='" + e.getRolid() + "'/>");
                out.println("</div>");
                out.println("<div class=\"mb-3\">");
                out.print("Name of department:<input type='text' name='rolename' class=\"form-control\" style=\"width: 270px;\" value='" + e.getRolename() + "'/>");
                out.println("</div>");
