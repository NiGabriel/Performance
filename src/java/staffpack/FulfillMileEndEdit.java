...
public class FulfillMileEndEdit extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (u == null) {
                ...
                out.println("<html>");
                out.println("<head>");
                out.println("<title>Fullfilling Milestone on the end year</title>");
                out.println("</head>");
                out.println("<body>");
                ...
                String achievedm = request.getParameter("achievedm");
                String achievedy = request.getParameter("achievedy");
                String achieved = "Mid:" + achievedm + " " + "End:" + achievedy;
