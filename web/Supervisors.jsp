...
<% user user = (user) session.getAttribute("logSupervisor");
    if (user == null) {
    ...
    <body>
        <section id="menu">
            ...
            <div class="items">
                ...
                <li><i class="fa-solid fa-comment"></i><a href="#feedback" id="a6" onclick="w3_open6()">STAFF FEEDBACK</a></li>                
                <li><i class="fa-brands fa-shirtsinbulk"></i><a href="#supervisorprofile" id="a7" onclick="w3_open7()">MY ACCOUNT PROFILE</a></li>
            </div>
        </section>
            ...
            <section id="dash">
                ...
                <div class="nav">
                    ...
                    <div class="prof">
                        <h3 style="padding: 7px; color: #594ef7;">  ACTIVE USER:
                            ...
                            <%= user.getSfname()%>
                            <%}%>
                            <button class="btn btn-primary"><a href="superlogout" style="color: white;">Log Out</a></button></h3>
                ...
                <%
                    ...
                    if (user != null) {
                        ...
                        String qCo = "SELECT count( * ) FROM milestone where departmentname = '" + user.getSdepartment() + "'";
                        String qCo1 = "SELECT count( * ) FROM assignedmilestone where departmentname = '" + user.getSdepartment() + "'";
                        String qCo2 = "SELECT count( * ) FROM pendingmilestone where departmentname = '" + user.getSdepartment() + "'";
                        String qCo3 = "SELECT count( * ) FROM report where departmentname = '" + user.getSdepartment() + "'";
                    ...
                    <table width="100%" id="tableUsers">
                        ...
                        <tbody>
                            <%
                                ...
                                das = "SELECT id, CONCAT(firstname,' ',lastname) AS firstname, email, username, position, role FROM staff where departmentname = '" + user.getSdepartment() + "' ORDER BY role";
                            ...
                            <form action="MilestoneRegisterServlet" method="post">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="datetime-local" class="form-control" id="start" name="idate" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">End date</label>
                                        <input type="datetime-local" class="form-control" id="end" name="edate" required>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <select name="weight" class="form-control">
                                            ...
                                            <%
                                                try {
                                                    ...
                                                    PreparedStatement pst = con.prepareStatement("select SUM(weight) AS weight from milestone where category ='" + x.getCatname() + "' and departmentname='" + user.getSdepartment() + "'");
                        ...
                        <div class="modal-content">
                            <form action="MilestoneRegisterServlet" method="post">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Input date</label>
                                        <input type="datetime-local" class="form-control" id="startm" name="idate" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">End date</label>
                                        <input type="datetime-local" class="form-control" id="endm" name="edate" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="exampleFormControlInput1" class="form-label">Weight</label>
                                        <select name="weight" class="form-control">
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 text-right">
                                <button class="btn btn-success badge-pill" data-bs-toggle="modal" data-bs-target="#addmilestone" style="width: 400px;"> ADD KPI ASSESSMENT MILESTONE </button>
                                <button class="btn btn-success badge-pill" data-bs-toggle="modal" data-bs-target="#compmilestone" style="width: 400px;"> ADD COMPETENCY ASSESSMENT MILESTONE </button>
                        ...
                        <table class="table table-hover" id="tableMilestone" >
                            ...
                            <tbody>
                                <%
                                    ...
                                    da = "select * from milestone where departmentname='" + user.getSdepartment() + "' order by description asc";
                                ...
                                <tr id="tmilestone">
                                    ...
                                    <td class="text-right">
                                        ...
                                        <a href='AssignMile?goal=<%=resu.getInt(1)%>'>Assign</a>

                                        <a href='SupervisorMilestoneEdit?goal=<%=resu.getInt(1)%>' style="padding: 15px;"><i class="fa-solid fa-eye"></i></a>

                                        <a href='MilestoneDeleteServlet?goal=<%=resu.getInt(1)%>'><i class="fa-solid fa-trash-can"></i></a>
                        ...
                        <table class="table table-hover" id="tableAssMilestone" >
                            ...
                            <tbody>
                                <%
                                    ...
                                    dass = "select * from assignedmilestone where departmentname='" + user.getSdepartment() + "' order by description asc";
                                    // dassign = "SELECT assignedmilestone.staffname FROM assignedmilestone RIGHT JOIN milestone ON assignedmilestone.target = milestone.target";
                                ...
                                <tr id="tassmilestone">
                                    ...
                                    <td class="text-right">
                                        <a href='UnassignMile?goal=<%=resass.getInt(1)%>&&staffname=<%=resass.getString(8)%>'>Unassign</a>
                                    </td>
                                    <%}%>
                        ...
                        <table class="table table-hover" id="tablePendMilestone" >
                            ...
                            <tbody>
                                <%
                                    ...
                                    dap = "select * from pendingmilestone where departmentname='" + user.getSdepartment() + "' order by description asc";
                                    // dassign = "SELECT assignedmilestone.staffname FROM assignedmilestone RIGHT JOIN milestone ON assignedmilestone.target = milestone.target";
                                ...
                                <tr id="tpendmilestone">
                                    ...
                                    <td class="text-right">
                                        ...
                                        <a href='MarkMileMid?goal=<%=resp.getInt(1)%>' style="padding: 15px;"><i class="fa-solid fa-eye"></i>Approve Mid year</a>


                                    </td>
                                    <td class="text-right">

                                        <a href='MarkMile?goal=<%=resp.getInt(1)%>' style="padding: 15px;"><i class="fa-solid fa-eye"></i>Approve End year</a>

                                    </td>
                                    <td class="text-right">

                                        <a href='RejectMile?goal=<%=resp.getInt(1)%>'><i class="fa-solid fa-trash-can"></i>Reject</a>
                        ...
                        <table class="table table-hover" id="tableRankMilestone" >
                            ...
                            <tbody>
                                <%
                                    ...
                                    darp = "select * from report where departmentname='" + user.getSdepartment() + "' order by description asc";
                                    // dassign = "SELECT assignedmilestone.staffname FROM assignedmilestone RIGHT JOIN milestone ON assignedmilestone.target = milestone.target";
                        ...
                        <table class="table table-hover" id="tablefeedback" >
                            ...
                            <tbody>
                                <%
                                    ...
                                    darf = "select * from feedback where departmentname = '" + user.getSdepartment() + "' order by date asc";
                                    // dassign = "SELECT assignedmilestone.staffname FROM assignedmilestone RIGHT JOIN milestone ON assignedmilestone.target = milestone.target";
            ...
            <section id="supervisorprofile">
                <div class="nav">
                    <div class="n2">
                        ...
                        <div class="searc">
                            ...
                            <i class="fa-solid fa-magnifying-glass"></i>
                            <form action="" method="get">
                                <input name="searchsuper" id="searchsuper" type="text" placeholder="Search">
                            </form>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <br>
                        <table class="table table-hover" id="tableSuper" >
                            <thead style="text-transform: uppercase;">
                                <tr>
                            ...
                            <tbody>
                                <%
                                    ...
                                    dadt = "select * from supervisor where departmentname='" + user.getSdepartment() + "' order by username asc";
                                ...
                                <tr id="super">
                                    ...
                                    <td class="text-right">
                                        ...
                                        <a href='SuperEdit?sidsuper=<%=resudt.getInt(1)%>' class="btn btn-primary badge-pill" style="width: 150px;">VIEW & EDIT</a>
        ...
        <script>
            ...
            document.getElementById("supervisorprofile").style.display = "none";
            }
            ...
            document.getElementById("rankedmile").style.display = "none";
            document.getElementById("feedback").style.display = "none";
            document.getElementById("supervisorprofile").style.display = "block";
            }
        ...
        <script>
            <script>                             var $rsup = $('#tableSuper #super');
            ...
            return !~text.indexOf(val); }).hide(
                    ...
                    var TotalValue = 0;
                    var categ = document.getElementById('cate').value;
                    if (
                            categ === 'Competency_assessment') {
                    $("tr #wei").each(function (index, value) {
                    currentRow = parseFloat($(this).text());
                    TotalValue += currentRow
                        });
                        
                            for (let i = 0; i <= (100-TotalValue); i++) {
                            document.getElementById('total').value = i;
                                }
                                } else if (categ === 'KPI_assessment'){
                            $("tr #wei").each(function (index, value) {
                    currentRow = parseFloat($(this).text());
                    TotalValue += currentRow
                                });
            ...
            <script>
                                    ...
                                    var endm  = document.getElementById('endm');
                                     ...
                                     startm.addEventListener('change', function() {
       
                                    if (startm.value)
                            endm.min = startm.value;
                                    }, false);
                                        endm.addEventLiseter('change', function() {
                            if (endm.value)
                            startm.max = endm.value;
                                    }, false);
                                </script>
        </body>
    </html>
